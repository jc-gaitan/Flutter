...
Widget columnChart(List<double> minutos) {
...
List<ColumnSeries<Asistencia, String>> _getDefaultColumnSeries(
  ...
  final List<Asistencia> chartData = <Asistencia>[
    Asistencia('LUN', minutos.elementAt(0)),
    Asistencia('MAR', minutos.elementAt(1)),
    Asistencia('MIE', minutos.elementAt(2)),
    Asistencia('JUE', minutos.elementAt(3)),
    Asistencia('VIE', minutos.elementAt(4)),
    Asistencia('SAD', minutos.elementAt(5)),
    Asistencia('DOM', minutos.elementAt(6)),
  ];
