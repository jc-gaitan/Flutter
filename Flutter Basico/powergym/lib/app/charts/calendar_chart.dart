...
Widget calendar(List<DateTime> diasAsistidos) {
  ...
  return SfDateRangePicker(
    ...
    selectionColor: monthCellBackground,
    selectionTextStyle: TextStyle(
      color: cellTextColor,
      fontSize: 14,
    ),
    //primer fecha del calendario -> poner la primer fecha de asistencia
    minDate: (diasAsistidos.elementAt(0).year == 2001)
        ? DateTime.now().add(const Duration(days: -10))
        : diasAsistidos
            .elementAt(0)
            .add(const Duration(days: -10)), //diasAsistidos
